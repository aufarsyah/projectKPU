    	...
    	<div class="toolbar" id="kt_toolbar">
    		...
    		<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
    			...
    			<div class="d-flex align-items-center me-3">
    				<!--begin::Title-->
    				<h1 class="d-flex align-items-center fw-bolder my-1 fs-3">User Setup</h1>
    				<!--end::Title-->
    				<!--begin::Separator-->
	            ...
	            success: function (data) {
	                ...
	                for (var i = 0; i < data.length; i++) {
	                    ...
	                    if (priv_user_update) {
		                    ...
		                    element+= '<a class="btn btn-icon btn-success me-2 btn_user_update" data-bs-toggle="modal" data-bs-target="#modal_data" onClick="updateClick(this)"><i class="bi bi-pencil-square fs-4"></i></a>';
	                    }
