        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div class="d-flex align-items-center me-3">
                    <!--begin::Title-->
                    <h1 class="d-flex align-items-center fw-bolder my-1 fs-3">Izin Menikah</h1>
                    <!--end::Title-->
                    <!--begin::Separator-->
                ...
                <div class="d-flex align-items-center py-1">
                    <!--begin::Button-->
                    @if(in_array("perizinan_nikah_setup_create", Session::get('privilege')))
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form enctype="multipart/form-data" class="form w-100" novalidate="novalidate" id="form_data">
                        ...
                        @method("POST")
                        @csrf
                        <input class="d-none" type="text" name="perizinan_nikah_id" id="perizinan_nikah_id" disabled="disabled" />
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form enctype="multipart/form-data" class="form w-100" novalidate="novalidate" id="form_notes">
                        ...
                        @method("POST")
                        @csrf
                        <input class="d-none" type="text" name="notes_nikah_id" id="notes_nikah_id" disabled="disabled" />
                        <div class="fv-row mb-7">
...
@section('javascript')
    ...
    <script type="text/javascript">
        ...
        var priv_perizinan_nikah_update = arr_privilege.includes('perizinan_nikah_setup_update');
        var priv_perizinan_nikah_delete = arr_privilege.includes('perizinan_nikah_setup_delete');
        var priv_notes_nikah_update = arr_privilege.includes('notes_nikah_setup_update');
        var priv_notes_nikah_delete = arr_privilege.includes('notes_nikah_setup_delete');
        let map;
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        if (priv_perizinan_nikah_update) {

                            element+= '<a class="btn btn-icon btn-success me-2 btn_area_update" data-bs-toggle="modal" data-bs-target="#modal_data" onClick="updateClick(this)"><i class="bi bi-pencil-square fs-4"></i></a>';
                        }

                        if (priv_perizinan_nikah_delete) {
                            
                            element+= '<a class="btn btn-icon btn-danger" id="btn_area_delete" onClick="deleteClick(this)"><i class="bi bi-trash fs-4"></i></a>';
                        }
                        
                        if (!priv_perizinan_nikah_update && !priv_perizinan_nikah_delete) {
        ...
        function updateClick(btn){
            ...
            $.each(cells, function() {  
                ...
                if($(this).data('id')) $('#perizinan_nikah_id').val($(this).data('id'));
        ...
        function updateClickNotes(btn){
            ...
            $.each(cells, function() {  
                ...
                if($(this).data('id')) $('#notes_nikah_id').val($(this).data('id'));
                ...
                submitButton.addEventListener('click', function (e) {
                    ...
                    validator.validate().then(function(status) {
                        if (status == 'Valid') {
                            ...
                            var perizinan_nikah_id = $('#perizinan_nikah_id').val();
                            ...
                            if (modalHeader == 'Tambah Data Perizinan') {
                                ...
                                $.ajax({
                                    url: '/perizinan_nikah/'+perizinan_nikah_id,
                                    type:'POST',
                                    cache: false,
                                    contentType: false,
                                    processData: false,
                ...
                submitButton.addEventListener('click', function (e) {
                    ...
                    validator.validate().then(function(status) {
                        if (status == 'Valid') {
                            ...
                            var notes_nikah_id = $('#notes_nikah_id').val();
                            ...
                            if (modalHeader == 'Tambah Notes') {
                                ...
                                $.ajax({
                                    url: '/notes_nikah/'+notes_nikah_id,
                                    type:'POST',
                                    cache: false,
                                    contentType: false,
                                    processData: false,
